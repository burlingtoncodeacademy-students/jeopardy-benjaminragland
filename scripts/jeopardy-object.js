...
let roundTwoCategories = [
...

  {
    ...
    amount: 400,
    question: "This is the alternate name for the fall season.",
    answer: "What is autumn",
  },
...

  {
    ...
    category: "Fall in Line with Fall",
    amount: 1200,
    question: "Fall begins south of the equator during this month.",
    answer: "What is March",
  },

  {
    ...
    category: "Fall in Line with Fall",
    amount: 1600,
    question: "This is the maximum number of games in the World Series.",
...

  {
    ...
    amount: 400,
    question:
      "Born on October 20, 1882, this Hungarian actor is best remembered for his role asthe most famous vampire of all time.",
    answer: "Who is Bela Lugosi?",
  },
...

  {
    ...
    amount: 2000,
    question:
      "Born October 1, 1950, he is best known for his roles as Cousin Eddie in National Lampoon’s Vacation franchise.",
    answer: "Who is Randy Quaid",
  },
...

  {
    ...
    amount: 1600,
    question:
      "On October 2, 1985, this actor, who often starred in romantic comedies such as Pillow Talk with Doris Day, died from complications of AIDS.",
    answer: "Who is Rock Hudson",
  },

  {
    ...
    amount: 2000,
    question:
      "On October 15, 1965, Vietnam War protesters demonstrated across the United States and burned these.",
